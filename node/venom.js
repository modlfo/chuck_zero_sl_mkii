...
Venom.prototype.setOSCRingMod = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x16,0x00,wave,0xF7];
    this.output.sendMessage(msg);
  };
  //------ Osc 1
...
Venom.prototype.setOsc1Coarse = function(level)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x1B,0x00,wave,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setOsc1Fine = function(level)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x1C,0x00,wave,0xF7];
    this.output.sendMessage(msg);
  };
...
Venom.prototype.setOsc2Coarse = function(level)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x1E,0x00,wave,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setOsc2Fine = function(level)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x1F,0x00,wave,0xF7];
    this.output.sendMessage(msg);
  };
...
Venom.prototype.setOsc1Level = function(level)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x64,0x00,wave,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setOsc2Level = function(level)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x65,0x00,wave,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setOsc3Level = function(level)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x66,0x00,wave,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setExtLevel = function(level)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x67,0x00,wave,0xF7];
    this.output.sendMessage(msg);
  };
