...
Venom.prototype.setVoiceTune = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x6E,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setVoiceTranspose = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x6D,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
...
Venom.prototype.setVoiceUnisonVoices = function(val)
  {
    if(val>12) val = 12;
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x71,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setVoiceUnisonDetune = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x72,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };  
...
Venom.prototype.setMod7Source = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x3A,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod7Destination = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x4A,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod7Amount = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x5A,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setMod8Source = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x3B,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod8Destination = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x4B,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod8Amount = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x5B,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setMod9Source = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x3C,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod9Destination = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x4C,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod9Amount = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x5C,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setMod10Source = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x3D,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod10Destination = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x4D,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod10Amount = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x5D,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };  

Venom.prototype.setMod11Source = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x3E,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod11Destination = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x4E,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod11Amount = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x5E,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setMod12Source = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x3F,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod12Destination = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x4F,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod12Amount = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x5F,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };   

Venom.prototype.setMod13Source = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x40,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod13Destination = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x50,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod13Amount = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x60,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setMod14Source = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x41,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod14Destination = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x51,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod14Amount = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x61,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setMod15Source = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x42,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod15Destination = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x52,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod15Amount = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x62,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };

Venom.prototype.setMod16Source = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x43,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod16Destination = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x53,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };
Venom.prototype.setMod16Amount = function(val)
  {
    var msg = [0xF0,0x00,0x01,0x05,0x21,0x00,0x02,0x09,0x00,0x63,0x00,val,0xF7];
    this.output.sendMessage(msg);
  };



Venom.prototype.sendMessage = function(msg){
  this.output.sendMessage(msg);
}
